...
class AddRecordDialog(QDialog):
    def __init__(self, parent=None):
        ...
        # Cargar un JSON vacío como plantilla después de que se haya cargado la página
        QTimer.singleShot(500, self.load_empty_json)

    def load_empty_json(self):
        """Cargar un JSON vacío como plantilla"""
        empty_json = {}
        json_str = json.dumps(empty_json, indent=2, ensure_ascii=False)
        # Pasar el JSON directamente
